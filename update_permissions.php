...
echo "Actualizando permisos de usuarios...\n";

$users = User::all();
$count = 0;

foreach ($users as $user) {
    echo "Procesando usuario: {$user->name} ({$user->rol})\n";
    
    $permissions = getPermissionsByRole($user->rol);
...
echo "Permisos actualizados para {$count} usuarios.\n";
