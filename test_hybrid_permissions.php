...
echo "=== PRUEBA DEL SISTEMA HÍBRIDO DE PERMISOS ===\n\n";
...
// Función para crear permisos basados en el rol y los módulos seleccionados
function createPermissionsFromRoleAndModules($selectedModules, $rol)
{
...
$testCases = [
    ...
    [
        ...
        'email' => 'tecnico_completo@test.com',
        'password' => 'password123',
        'rol' => 'tecnico',
    ...
    [
        ...
        'email' => 'tecnico_equipos@test.com',
        'password' => 'password123',
        'rol' => 'tecnico',
    ...
    [
        ...
        'email' => 'usuario_dashboard@test.com',
        'password' => 'password123',
        'rol' => 'usuario',
...
foreach ($testCases as $testUser) {
    try {
        ...
        // Asignar permisos según el rol y módulos seleccionados
        $permissions = createPermissionsFromRoleAndModules($testUser['modules'], $testUser['rol']);
        ...
        echo "   Módulos seleccionados: " . implode(', ', $testUser['modules']) . "\n";
...
echo "- Admin Completo: admin_completo@test.com / password123\n";
echo "- Admin Limitado: admin_limitado@test.com / password123\n";
echo "- Técnico Completo: tecnico_completo@test.com / password123\n";
echo "- Técnico Solo Equipos: tecnico_equipos@test.com / password123\n";
echo "- Usuario Básico: usuario_basico@test.com / password123\n";
echo "- Usuario Solo Dashboard: usuario_dashboard@test.com / password123\n";
