...
<div class="container-fluid">
    ...
    <div class="form-header mb-4">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="form-title">
                    <i class="fas fa-user-plus text-gradient me-3"></i>
                    Nuevo Cliente
                </h1>
                <p class="form-subtitle">Registra un nuevo cliente en el sistema de gestión</p>
            </div>
            <div class="col-lg-4 text-end">
                <a href="{{ route('clientes.index') }}" class="btn btn-outline-secondary btn-modern">
        ...
        <div class="col-lg-10">
            <div class="form-card">
                <div class="form-card-header">
                    ...
                    <p class="mb-0 text-muted">Completa todos los campos requeridos para registrar el cliente</p>
                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control modern-textarea @error('direccion') is-invalid @enderror" 
                                                  ...
                                                  name="direccion" 
                                                  rows="3" 
                                                  placeholder="Ingresa la dirección completa del cliente">{{ old('direccion') }}</textarea>
                                        @error('direccion')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control modern-textarea @error('observaciones') is-invalid @enderror" 
                                                  ...
                                                  name="observaciones" 
                                                  rows="3" 
                                                  placeholder="Agrega observaciones adicionales sobre el cliente">{{ old('observaciones') }}</textarea>
                                        @error('observaciones')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
