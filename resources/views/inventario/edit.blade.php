...
@section('title', 'Editar Item - ' . $inventario->nombre)
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="module-title">
                    <i class="fas fa-edit text-gradient me-3"></i>
                    Editar Item de Inventario
                </h1>
                <p class="module-subtitle">Modifica la información del item: {{ $inventario->nombre }}</p>
            </div>
            <div class="col-lg-4 text-end">
                <a href="{{ route('inventario.show', $inventario) }}" class="btn btn-outline-light btn-lg btn-modern me-2">
                ...
                <form action="{{ route('inventario.update', $inventario) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                  ...
                                  name="descripcion" 
                                  rows="3" 
                                  placeholder="Descripción detallada del producto...">{{ old('descripcion', $inventario->descripcion) }}</textarea>
                        @error('descripcion')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('categoria') is-invalid @enderror" id="categoria" name="categoria">
                                ...
                                @foreach($categorias as $key => $categoria)
                                    <option value="{{ $categoria }}" {{ old('categoria', $inventario->categoria) == $categoria ? 'selected' : '' }}>
                                        {{ $categoria }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('estado') is-invalid @enderror" id="estado" name="estado">
                                <option value="activo" {{ old('estado', $inventario->estado) == 'activo' ? 'selected' : '' }}>Activo</option>
                                <option value="inactivo" {{ old('estado', $inventario->estado) == 'inactivo' ? 'selected' : '' }}>Inactivo</option>
                                <option value="agotado" {{ old('estado', $inventario->estado) == 'agotado' ? 'selected' : '' }}>Agotado</option>
                                <option value="discontinuado" {{ old('estado', $inventario->estado) == 'discontinuado' ? 'selected' : '' }}>Discontinuado</option>
                            </select>
                            @error('estado')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="serie" 
                                   name="serie" 
                                   value="{{ old('serie', $inventario->serie) }}" 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" 
                                   ...
                                   id="fecha_compra" 
                                   name="fecha_compra" 
                                   value="{{ old('fecha_compra', $inventario->fecha_compra ? $inventario->fecha_compra->format('Y-m-d') : '') }}">
                            @error('fecha_compra')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" 
                                   ...
                                   value="{{ old('fecha_vencimiento', $inventario->fecha_vencimiento ? $inventario->fecha_vencimiento->format('Y-m-d') : '') }}">
                    ...
                    <div class="mb-3">
                        ...
                        @error('imagen')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="form-text text-muted">Formatos permitidos: JPG, PNG, GIF. Máximo 2MB. Deja vacío para mantener la imagen actual.</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('notas') is-invalid @enderror" 
                                  ...
                                  name="notas" 
                                  rows="3" 
                                  placeholder="Información adicional, observaciones...">{{ old('notas', $inventario->notas) }}</textarea>
                        @error('notas')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('inventario.show', $inventario) }}" class="btn btn-outline-secondary">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info border-0">
                    ...
                    <strong>Tip:</strong> Los cambios se guardarán inmediatamente al hacer clic en "Actualizar Item".
                </div>
            </div>
        </div>
    </div>
