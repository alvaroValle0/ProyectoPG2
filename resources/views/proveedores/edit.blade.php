    ...
    <div class="form-header mb-4">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <p class="form-subtitle">Modifica la información del proveedor: <strong>{{ $proveedor->nombre_empresa }}</strong></p>
            </div>
            <div class="col-lg-4 text-end">
                <a href="{{ route('proveedores.show', $proveedor) }}" class="btn btn-outline-info btn-modern me-2">
        ...
        <div class="col-lg-10">
            <div class="form-card">
                <div class="form-card-header">
                    ...
                    <p class="mb-0 text-muted">Actualiza los campos que desees modificar</p>
                </div>
                <div class="form-card-body">
                    <form action="{{ route('proveedores.update', $proveedor) }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select modern-select @error('tipo_proveedor') is-invalid @enderror" 
                                            ...
                                            @foreach($tiposProveedor as $valor => $etiqueta)
                                                <option value="{{ $valor }}" {{ old('tipo_proveedor', $proveedor->tipo_proveedor) === $valor ? 'selected' : '' }}>
                                                    {{ $etiqueta }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('nombre_representante', $proveedor->nombre_representante) }}" 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" 
                                               ...
                                               id="telefono_fijo" 
                                               name="telefono_fijo" 
                                               value="{{ old('telefono_fijo', $proveedor->telefono_fijo) }}" 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" 
                                               ...
                                               id="telefono_movil" 
                                               name="telefono_movil" 
                                               value="{{ old('telefono_movil', $proveedor->telefono_movil) }}" 
                                               placeholder="0000-0000"
                                               maxlength="20">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" 
                                               ...
                                               value="{{ old('email_alternativo', $proveedor->email_alternativo) }}" 
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control modern-input @error('direccion') is-invalid @enderror" 
                                                  ...
                                                  name="direccion" 
                                                  rows="3" 
                                                  placeholder="Ingresa la dirección completa de la empresa">{{ old('direccion', $proveedor->direccion) }}</textarea>
                                        @error('direccion')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('categoria_productos', $proveedor->categoria_productos) }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old('tiempo_entrega_promedio', $proveedor->tiempo_entrega_promedio) }}" 
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control modern-input @error('descripcion_general') is-invalid @enderror" 
                                                  ...
                                                  rows="4" 
                                                  placeholder="Describe los productos/servicios que ofrece este proveedor">{{ old('descripcion_general', $proveedor->descripcion_general) }}</textarea>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control modern-input @error('observaciones') is-invalid @enderror" 
                                                  ...
                                                  name="observaciones" 
                                                  rows="3" 
                                                  placeholder="Información adicional sobre el proveedor">{{ old('observaciones', $proveedor->observaciones) }}</textarea>
                                        @error('observaciones')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-end gap-3">
                                        <a href="{{ route('proveedores.show', $proveedor) }}" class="btn btn-outline-secondary btn-lg">
