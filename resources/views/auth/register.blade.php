            ...
            <div class="col-md-6 col-lg-5">
                <div class="register-card p-4 p-md-5">
                    <div class="text-center mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2">
                                <span class="badge" style="background: linear-gradient(135deg, #F2AE4E 0%, #E89A3A 100%); font-size: 0.7rem; padding: 4px 12px;">
                                    <i class="fas fa-user-shield me-1"></i>Registro Seguro
                                </span>
                            </div>
                        </div>
                        ...
                        <p class="text-muted">Completa el formulario para acceder al sistema</p>
                    </div>
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('login') }}" class="btn btn-outline-primary social-btn">
