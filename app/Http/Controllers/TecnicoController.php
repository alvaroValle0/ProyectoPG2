...
class TecnicoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'dpi' => 'required|string|max:20|unique:tecnicos,dpi',
    ...
    public function update(Request $request, Tecnico $tecnico)
    {
        $validated = $request->validate([
            ...
            'email_personal' => 'nullable|email|max:255',
            'direccion' => 'nullable|string',
            'dpi' => 'required|string|max:20|unique:tecnicos,dpi,' . $tecnico->id,
            'foto' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048',
            'fecha_nacimiento' => 'nullable|date|before:today',
            'genero' => 'nullable|in:masculino,femenino,otro',
            'estado_civil' => 'nullable|string|max:255',
        ...
        $tecnicos = Tecnico::activos()
            ...
            ->map(function ($tecnico) {
                return [
                    ...
                    'carga_trabajo' => $tecnico->carga_trabajo,
                    'reparaciones_activas' => $tecnico->reparacionesActivas
                ];
            });
